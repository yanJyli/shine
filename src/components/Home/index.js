        ...
        return (
            <>
                ...
                <div className='bg-white max-w-screen-lg mx-auto'>
                    ...
                    <p className='mt-8 p-4 text-lg'>А с каждым годом мне все сложнее найти вещи себе по вкусу - все было, все не то. Многие девочки конечно меня поймут. Поэтому я решила запустить свою линейку одежды @shine_belarus , где вы не найдёте простоты, а только самое интересное на каждый день и не только. Дизайнер рассказывает свое видение моды и стиля через продукт. Коллекция - это продолжение дизайнера, а элементы дизайна, стиля, материалы и подача  - это способы коммуникации дизайнера с его аудиторией. Сияй-сияй-сияй!</p>
